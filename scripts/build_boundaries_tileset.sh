...
tippecanoe -f -o "$TMP_DIR/boundary_county.mbtiles" -l counties -Z5 -z10 --buffer=2 --drop-smallest-as-needed --coalesce-smallest-as-needed --coalesce-densest-as-needed --simplification=2 "$BUILD_DIR/county_lines_low.geojson"

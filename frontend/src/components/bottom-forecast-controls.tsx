        ...
        <div className="pointer-events-auto flex w-full max-w-3xl flex-col gap-3 rounded-2xl glass-strong px-5 py-4 sm:flex-row sm:items-center sm:gap-5">
          ...
          <div className="flex flex-1 flex-col gap-1.5">
            ...
            <Slider
              ...
              className="w-full transition-opacity duration-150 [&>*:first-child]:h-2.5 [&>*:first-child]:bg-secondary/55 [&>*:first-child>*:first-child]:bg-[linear-gradient(to_top_right,#1f342f_0%,#526d5c_100%)] [&>*:nth-child(2)]:h-[22px] [&>*:nth-child(2)]:w-[22px] [&>*:nth-child(2)]:border-[#526d5c]/95 [&>*:nth-child(2)]:bg-[linear-gradient(to_top_right,#1f342f_0%,#526d5c_100%)] [&>*:nth-child(2)]:shadow-[0_0_0_1px_rgba(31,52,47,0.9),0_0_12px_rgba(82,109,92,0.52)] [&>*:nth-child(2)]:focus-visible:ring-0 [&>*:nth-child(2)]:focus-visible:ring-offset-0"
            />
          </div>
